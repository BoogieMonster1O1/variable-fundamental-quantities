...
export class Quantity {
    ...
    public static readonly ELECTRIC_DIPOLE_MOMENT: Quantity = Quantity.of("Electric Dipole Moment", {unit: "coulomb meter", shortUnit: "Cm", length: Fraction.ofWhole(1), mass: Fraction.ofWhole(0), time: Fraction.ofWhole(1), current: Fraction.ofWhole(1)});
